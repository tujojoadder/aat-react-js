...
import "./IChannelPhotos.css"; // Ensure you create and import this CSS file
import { useInView } from "react-intersection-observer";
import Spinner from "../../Spinner/Spinner";
import { useGetSpecificIChannelPhotoQuery } from "../../../services/iaccountsApi";

const IChannelPhotos = ({ iChannelId }) => {
  ...
  } = useGetSpecificIChannelPhotoQuery({ photoPage, iChannelId });
        ...
        {allPhotos.map((photo, index) => (
          <div className="col-4 mb-4" key={index}>
            <div className="image-container">
              <img
                src={`${process.env.REACT_APP_LARAVEL_URL}/${photo?.image_post?.post_url}`} // Assuming 'url' is the correct key for the image URL
