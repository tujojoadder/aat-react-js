...
export default function CreateIChannelPosts({ iChannelId }) {
  ...
  const [userPostInsert, { isLoading, isError, isSuccess, error }] = useUserIAccountPostInsertMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("iChannelId", iChannelId); // Add iChannelId to FormData
