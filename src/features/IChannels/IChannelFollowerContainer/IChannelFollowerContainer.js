...
import { useGetSpecificIaccountFollowerFriendQuery } from '../../../services/iaccountsApi';

export default function IChannelFollowerContainer({ iChannelId }) {
  ...
  } = useGetSpecificIaccountFollowerFriendQuery({ followerPage, iChannelId });
