...
>
      ...
      <div className="row">
        {/* LEFT SIDE BAR */}
        <div style={{backgroundColor:'#f1f3f5',height:'105vh'}}  className="p-0 d-none col-sm-2 d-sm-block col-md-2 col-lg-3 d-flex flex-column text-sm-end text-md-start align-items-lg-start left_sidebar  ">
