...
export default function HadithStatus() {
  ...
  return (
    <div className="border-bottom border-start border-end pt-2 pb-3 d-flex align-items-center position-relative wrapper-container" style={{backgroundColor:'#f8f9fa'}}>
    <button
